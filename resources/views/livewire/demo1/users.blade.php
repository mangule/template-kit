                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex flex-wrap gap-2">
                                            <img alt="" class="size-[18px] shrinc-0"
                                                src="{{ asset('assets/media/brand-logos/slack.svg') }}">
                                            <img alt="" class="size-[18px] shrinc-0"
                                                src="{{ asset('assets/media/brand-logos/twitch-purple.svg') }}">
                                            <img alt="" class="size-[18px] shrinc-0"
                                                src="{{ asset('assets/media/brand-logos/invision.svg') }}">
                                            </img>
                                            </img>
                                            </img>
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex flex-wrap gap-2">
                                            <img alt="" class="size-[18px] shrinc-0"
                                                src="{{ asset('assets/media/brand-logos/google-analytics.svg') }}" />
                                            <img alt="" class="size-[18px] shrinc-0"
                                                src="{{ asset('assets/media/brand-logos/google-calendar.svg') }}" />
                                        </div>
                                    </td>
                                    <td>
                                        <div class="flex flex-wrap gap-1.5">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex flex-wrap gap-2">
                                            <img alt="" class="size-[18px] shrinc-0"
                                                src="{{ asset('assets/media/brand-logos/tiktok-2.svg') }}" />
                                            <img alt="" class="size-[18px] shrinc-0"
                                                src="{{ asset('assets/media/brand-logos/monetha.svg') }}" />
                                            <img alt="" class="size-[18px] shrinc-0"
                                                src="{{ asset('assets/media/brand-logos/twitch-purple.svg') }}" />
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex flex-wrap gap-2">
                                            ...
                                            <img alt="" class="size-[18px] shrinc-0"
                                                src="{{ asset('assets/media/brand-logos/instagram-2.svg') }}" />
                                        </div>
                                    </td>
                                    <td>
                                        <div class="flex flex-wrap gap-1.5">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex flex-wrap gap-2">
                                            <img alt="" class="size-[18px] shrinc-0"
                                                src="{{ asset('assets/media/brand-logos/azure.svg') }}" />
                                        </div>
                                    </td>
                                    <td>
                                        <div class="flex flex-wrap gap-1.5">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex flex-wrap gap-2">
                                            ...
                                            <img alt="" class="size-[18px] shrinc-0"
                                                src="{{ asset('assets/media/brand-logos/weave.svg') }}" />
                                            <img alt="" class="size-[18px] shrinc-0"
                                                src="{{ asset('assets/media/brand-logos/plastic-scm.svg') }}" />
                                        </div>
                                    </td>
                                    <td>
                                        <div class="flex flex-wrap gap-1.5">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex flex-wrap gap-2">
                                            <img alt="" class="size-[18px] shrinc-0"
                                                src="{{ asset('assets/media/brand-logos/sololearn.svg') }}" />
                                            <img alt="" class="size-[18px] shrinc-0"
                                                src="{{ asset('assets/media/brand-logos/twitch-purple.svg') }}" />
                                            <img alt="" class="size-[18px] shrinc-0"
                                                src="{{ asset('assets/media/brand-logos/linkedin.svg') }}" />
                                            <img alt="" class="size-[18px] shrinc-0"
                                                src="{{ asset('assets/media/brand-logos/office.svg') }}" />
                                        </div>
                                    </td>
                                    <td>
                                        <div class="flex flex-wrap gap-1.5">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex items-center gap-2.5">
                                            <img alt="" class="rounded-full size-7 shrink-0"
                                                src="{{ asset('assets/media/avatars/300-31.png') }}" />
                                            <a class="text-sm font-medium text-mono hover:text-primary"
                                                href="#">
                                                Matthew Martinez
                                            </a>

<div class="p-6 space-y-6 w-full mx-auto kt-container-fluid">
    ...
    <!-- Header -->
    <div class="mb-6">
        <h1 class="text-2xl font-medium text-gray-900">Edit Roles</h1>
                ...
                <div class="border border-gray-200 p-4 rounded-lg shadow-sm"
                    ...
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <input type="checkbox" wire:change="toggleGroup('{{ $group }}')"
                            @checked($form->groupCheckStatus[$group] ?? false)
                            class="kt-checkbox kt-checkbox-sm rounded border-gray-300 text-black focus:ring-black" />

            ...
            <form action="{{ route('register') }}" class="kt-card-content flex flex-col gap-5 p-10" id="sign_up_form"
                ...
                <div class="text-center mb-2.5">
                    ...
                    <div class="flex items-center justify-center">
                        ...
                        <a class="text-sm link" href="login">
                            Sign In
                        </a>
                    </div>
                </div>
                ...
                <div class="kt-form-item flex flex-col gap-1">
                    ...
                    <input class="kt-input" name="name" placeholder="Full Name" type="text" id="name"
                        aria-invalid="{{ $errors->has('name') ? 'true' : '' }}" value="" autocomplete="off" />
                ...
                <div class="kt-form-item flex flex-col gap-1">
                    ...
                    <input class="kt-input" name="email" placeholder="email@email.com" type="text"
                        aria-invalid="{{ $errors->has('email') ? 'true' : '' }}" value="" />
                    @error('email')
                        <div class="kt-form-message">{{ $message }}</div>
                    @enderror
                </div>
